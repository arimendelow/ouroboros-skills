...
Commands run for the original artifact generation:
...
- current_artifact_source_scope_hash: sha256:a0ae309cfbcc53403916090fd08a33b89b891b2492652fe648f677ae77d64ac6
- current_document_tree_hash: sha256:b8268841c4877dfe293de7c463eadf38339c741daa6416ffd5b1ec652087fba8

The local `desk-mcp@1.4.0-alpha.6` candidate now uses chunker identity `desk-md-h2-paragraph-v2`, which bounds oversized prose paragraphs before embedding, retains fenced code blocks as atomic chunks, and rejects empty output after trimming. For the current alpha.6 re-anchor, the already-approved one-document local index was reused directly: no `desk_reindex` operation or embedding request occurred, represented documents and artifact payload bytes remained unchanged, and only source-sensitive freshness and provenance metadata was regenerated through the maintained vector-pack and snapshot builders with `--from-local-db`, anchored to source-surface commit `0055396f26bf694c1433907931ac73502852c89e`. The artifact source scope now comes from one canonical configuration consumed by runtime admission, builders, and the independent generated-artifact verifier; validators require the exact canonical path set, and the scope includes the chunker, active embedding specification, vector-pack and snapshot validators, and source-scope definition so those compatibility and privacy inputs cannot change while an old artifact remains fresh. The [v2 vector manifest](../../../plugins/desk/artifacts/vector-packs/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records two vectors, one represented document, and rows checksum `edf5dd39ec4a23020fe05769dd0e4e65b45c2143d1c02365793681ac2ba5bad8`. The [v2 snapshot manifest](../../../plugins/desk/artifacts/snapshots/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records snapshot checksum `sha256:5fde90db26523f0a5750b1296ed0618e83c0190b0da39ce7a396e81ed532a116`. Both manifests retain the current source-scope and document-tree freshness anchors above. The published sections below retain the historical v1 identities and are not claims that this v2 Alpha candidate was published or passed native admission.
