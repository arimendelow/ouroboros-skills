...
The local `desk-mcp@1.4.0-alpha.6` candidate now uses chunker identity `desk-md-h2-paragraph-v2`, which bounds oversized prose paragraphs before embedding while retaining fenced code blocks as atomic chunks. The approved repo-local public Desk source was reindexed through the maintained indexer with two successful `nomic-embed-text` document embeddings and zero missing vectors, then rebuilt through the maintained vector-pack and snapshot builders with `--from-local-db`, anchored to source-surface commit `ffaa2eea5775156c7ed5554b9d54cd61b1e7462c`. The [v2 vector manifest](../../../plugins/desk/artifacts/vector-packs/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records two vectors, one represented document, and rows checksum `edf5dd39ec4a23020fe05769dd0e4e65b45c2143d1c02365793681ac2ba5bad8`. The [v2 snapshot manifest](../../../plugins/desk/artifacts/snapshots/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records snapshot checksum `sha256:bc9babfeefc85459da90036eb521ba873409d6d4ce53f9f04fd37fcfc3b7b9fd`. Both manifests retain the current source-scope and document-tree freshness anchors above. The published sections below retain the historical v1 identities and are not claims that this v2 Alpha candidate was published or passed native admission.
