...
- current_artifact_source_scope_hash: sha256:939dfa59685ff7c8291003a9115b430d2a8540922a7ef3aa28fcb349715c6c09
- current_document_tree_hash: sha256:b8268841c4877dfe293de7c463eadf38339c741daa6416ffd5b1ec652087fba8

The local `desk-mcp@1.4.0-alpha.6` candidate now uses chunker identity `desk-md-h2-paragraph-v2`, which bounds oversized prose paragraphs before embedding while retaining fenced code blocks as atomic chunks. The approved repo-local public Desk source was reindexed through the maintained indexer with two successful `nomic-embed-text` document embeddings and zero missing vectors, then rebuilt through the maintained vector-pack and snapshot builders with `--from-local-db`, anchored to source-surface commit `7d661fb07c3e25f42eb0ece49868c0618c5ecee4`. The artifact source scope now comes from one canonical configuration consumed by runtime admission, builders, and the independent generated-artifact verifier; it includes the chunker, active embedding specification, and source-scope definition so those compatibility inputs cannot change while an old artifact remains fresh. The [v2 vector manifest](../../../plugins/desk/artifacts/vector-packs/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records two vectors, one represented document, and rows checksum `edf5dd39ec4a23020fe05769dd0e4e65b45c2143d1c02365793681ac2ba5bad8`. The [v2 snapshot manifest](../../../plugins/desk/artifacts/snapshots/nomic-embed-text-v1_5-desk-md-h2-paragraph-v2-unicode-whitespace-v1-768/repo-public-bootstrap-2026-06-15.manifest.json) records snapshot checksum `sha256:bc9babfeefc85459da90036eb521ba873409d6d4ce53f9f04fd37fcfc3b7b9fd`. Both manifests retain the current source-scope and document-tree freshness anchors above. The published sections below retain the historical v1 identities and are not claims that this v2 Alpha candidate was published or passed native admission.
